...
class Hand_Detector:
    def __init__(self, max_num_hands=2, min_detection_confidence=0.9, carpeta_destino="A", n_imagenes=60):
        ...
        if resultado.multi_hand_landmarks:
            for mano_landmarks in resultado.multi_hand_landmarks:
                ...
                if self.captura_imagenes and self.contador_imagenes < self.n_imagenes:
                    ...
                    nombre_foto = os.path.join(self.carpeta_destino, f"A_{self.contador_imagenes + 181}.jpg")
